Changes: https://github.com/supertokens/frontend-driver-interface/issues/14
# For all recipes
...
```
{
    ...
    status: "WRONG_OTP_OR_EMAIL_ERROR"
}
```
...
## Check if email exists API
### URL: `{apiBasePath}/signinup/email/exists`
### Method: `GET`
